<div class="app-header">
    ...
    <div class="app-header-right">
        ...
        @endif
        @else
        <button class="add-btn" onclick="document.getElementById('modal-project').classList.add('open');" title="Add New Project">
    ...
    <div class="modal-section" id="modal-project">
        <div class="modal-content">
            <button class="modal-close" onclick="document.getElementById('modal-project').classList.remove('open');">&times;</button>
